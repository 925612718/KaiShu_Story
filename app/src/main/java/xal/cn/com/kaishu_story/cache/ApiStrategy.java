...
public class ApiStrategy {
    public static String baseUrl = "https://api.kaishustory.com/";
    //读超时长，单位：毫秒
        ...
        Interceptor headerInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                Request build = chain.request().newBuilder()
                        ...
                        .addHeader("token", "{\"to\":2509970714539,\"rd\":\"561509970715539\",\"il\":true,\"aid\":\"992099001\",\"userid\":\"92008740\"}|NEJBQkRGN0I4MDNDRjA5RDRENENEMDAxNUQyMEYxNjY=")
                        .build();
