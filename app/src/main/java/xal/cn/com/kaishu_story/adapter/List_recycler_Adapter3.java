...
public class List_recycler_Adapter3 extends RecyclerView.Adapter<List_recycler_Adapter3.ViewHolder> {
    private Context context;
    private List<Taletell_list_bean.ResultBean.ListBean.ContentBean> content;

    public List_recycler_Adapter3(Context context, List<Taletell_list_bean.ResultBean.ListBean.ContentBean> content) {
